...
module.exports = async (req, res) => {
  ...
  if(Number(req.user.id) !== userId) return res.status//(statusCode.BAD_REQUEST).send(util.fail(statusCode.BAD_REQUEST, responseMessage.OUT_OF_VALUE));
  ...
  try {
    ...
    // user파일에서 false로 받아온 existingRows에 대한 예외처리
